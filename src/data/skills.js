...
const SKILLS = [
  ...
  { id:'S_BUDGET',  label:'Budget & Financial Management', cat:'Leadership', alias:['budget','P&L','financial management','cost management','capitalization','deferred revenue','GL coding'],
    desc:'Responsible for AWS infrastructure budget across several accounts (a $250K+ and a shared $1.2M account) with monthly tracking and semi-annual updates, determining and monitoring AI & Inference compute as that spend scales (~$50K), and managing capital investment spend including quarterly software capitalization reporting. On every product launch, my team partners directly with tax and accounting on GL coding and deferred-revenue setup, and drives pricing experimentation through tracking codes and discount offerings.' },
