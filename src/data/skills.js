...
const SKILLS = [
  ...
  { id:'S_BUDGET',  label:'Budget & Financial Management', cat:'Leadership', alias:['budget','P&L','financial management','cost management','capitalization'],
    desc:'Defining and owning a $200K+ AWS infrastructure budget with monthly tracking and semi-annual updates, determining and monitoring AI compute budgets as that spend scales, and managing capital investment spend including quarterly software capitalization reporting.' },
