...
"",
"### The organization",
"- **Catalog Platform** - catalog query, offer enrichment, the translation compatibility layer, and the new catalog-variants service.",
"- **Product Creation / CMT** - product intake, TLD master listing, catalog UI, and internal agent tooling.",
"- **Basket Service** - basket, order shim, and shadow routing onto the new commerce stack.",
"- Contiuous growth: **refund automation** and **AI credit reserve** are moving into the org.",
"",
"### What I am accountable for",
"**Catalog modernization.** Migrating a long-lived legacy catalog onto a variant/offer/product semantic model behind a translation seam, so V2 callers keep working while V3 rolls out. That one catalog prices and manages the lifecycle for domains, hosting, SSL and security products, email plans, website builder and commerce add-ons, payment products, and the emerging AI Credit reserve. Eevery SKU behind the storefront runs through the same pricing and offer model.",
"",
"**Commerce-stack migration.** Order and basket traffic moves onto the new stack on AWS in shadow mode and is only cut over once diffs are clean - the orders-translation cutover held at **99.6% shadow match**. Requireing named code owners on the legacy repository so changes cannot land unnoticed by the new platform.",
"",
"**Platform resilience.** Timeouts and circuit breakers on downstream calls, bounded caches, connection-pool isolation for noisy upstreams, and a deliberate caching strategy. Observability with Elastic, Graphana, and Cloudtrail logs",
"",
"**Engineering standards.** Teams adopted an enforced coverage on new code - **90% unit, 100% functional-API** - tracked per repository.",
"",
"**Full-cycle recruiting.** I run the full-time hiring pipeline end to end - sourcing, screening, structured interview loops, offer strategy and closing - using tooling including **HackerRank, ModernLoop, Greenhouse, LinkedIn Recruiting** and **WorkDay**.",
"",
"**Contractor and staffing management.** I own the software engineering contractor lifecycle end to end - sourcing and acquisition, statement-of-work negotiation, onboarding, day-to-day management, and renewal or offboarding - including **budget ownership and contract approval** for every engagement - augmenting my full-time teams with staffing vendors including **EPAM, Tech Systems, Globant, Apex Systems, Lviv IT** and others.",
"",
"**Budget, vendor and investment management.** I define and own **AWS infrastructure budget** running across **US West, US East, and EU West** regions, tracking spend monthly and updating the forecast semi-annually, plus determining and monitoring the org's **AI budget** as that spend scales. This extends to vendor management with delivery partners, and to managing capital investment spend - submitting accurate **quarterly software capitalization reports** for engineering work that qualifies.",
"",
