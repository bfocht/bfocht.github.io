...
"- Driving **AI adoption** across the org's platform and compliance work - including an intern-built AI agent that replaced a manual **SOX tax-review** spreadsheet process, delivering a **10x productivity** gain - while building the underlying agent infrastructure (Product MCP server, Product Creation Agent and workflow orchestration) other teams now build on.",
"",
"### Platform ownership & impact",
"- **Catalog, product-creation and basket platform** - the pricing and offer engine behind GoDaddy's entire storefront. I modernized a long-lived legacy catalog onto a variant/offer/product semantic model behind a translation seam, so every SKU - domains, hosting, SSL/security, email, website builder, commerce add-ons, payment products, and the emerging AI Credit reserve - prices consistently without breaking existing callers mid-rollout.",
